...
public class Principal extends JFrame implements ActionListener {
	...
	// Informaci贸n de microprocesadores:
	...
	public static double porcentaje4 = 15.0; // Descuento para m醩 de 15 unidades
	...
	public Principal() {
		...
		mnConfig = new JMenu("Configurac铆贸n");
		mnBar.add(mnConfig);
	...
	protected void actionPerformedMntmEdici贸n(ActionEvent e) {
